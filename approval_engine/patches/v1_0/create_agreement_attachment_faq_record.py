...
# apps/approval_engine/approval_engine/patches/v1_0/create_agreement_attachment_faq_record.py
"""
...
Registered in patches.txt as:
    approval_engine.patches.v1_0.create_agreement_attachment_faq_record
"""
