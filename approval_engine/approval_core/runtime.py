...
from approval_engine.approval_core.generator import amount_field_for, find_band_row, workflow_name
...
def _block_if_no_band(doc):
	...
	if not row:
		frappe.throw(
			_(
				"No approval matrix band is defined for {0} / {1} at amount {2}. "
