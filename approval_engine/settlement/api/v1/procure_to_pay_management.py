...
settlement/customization/procure_to_pay/dashboard_data.py and period_closing.py.
"""
...
from approval_engine.settlement.customization.procure_to_pay.period_closing import (
...
def get_dashboard_data(
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.procure_to_pay_management.get_dashboard_data`
...
def check_access():
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.procure_to_pay_management.check_access`
	**HTTP Method:** GET, POST
	**Parameters:**
	        None
...
def debug_raw_counts(
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.procure_to_pay_management.debug_raw_counts`
	**HTTP Method:** GET, POST
	**Parameters:**
...
def debug_line_items(
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.procure_to_pay_management.debug_line_items`
	**HTTP Method:** GET, POST
	**Parameters:**
	        - doctype (str, required): One of BRN, Purchase Order, Purchase Invoice, Payment Order
	        - company (str, optional): Company to scope the data to
...
def get_error_logs(
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.procure_to_pay_management.get_error_logs`
	**HTTP Method:** GET, POST
	**Parameters:**
...
def can_view_period_closing():
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.procure_to_pay_management.can_view_period_closing`
	**HTTP Method:** GET, POST
	**Parameters:**
	        None
...
def update_accounts_frozen_till_date(accounts_frozen_till_date: str):
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.procure_to_pay_management.update_accounts_frozen_till_date`
	**HTTP Method:** POST
	**Parameters:**
