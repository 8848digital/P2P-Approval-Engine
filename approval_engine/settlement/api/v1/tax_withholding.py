...
def get_tax_withholding_category(nature_of_service: str, supplier: str | None = None):
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.tax_withholding.get_tax_withholding_category`
...
def get_tax_withholding_categories(nature_of_services: str | list, supplier: str | None = None):
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.tax_withholding.get_tax_withholding_categories`
	**HTTP Method:** GET, POST
	**Parameters:**
