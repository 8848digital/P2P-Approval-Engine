...
from approval_engine.settlement.kyc_validation import vendor_check
...
def get_kyc_vendor_options(supplier: str | None = None):
	"""
	        ...
	        **Endpoint:** `/api/method/approval_engine.settlement.api.v1.kyc_validation.get_kyc_vendor_options`
...
def run_kyc_validation(supplier: str, vendors: str | list):
	"""
	        ...
	        **Endpoint:** `/api/method/approval_engine.settlement.api.v1.kyc_validation.run_kyc_validation`
	        **HTTP Method:** POST
	        **Parameters:**
...
def revalidate_in_run(run_name: str, vendors: str | list, remarks: str | None = None):
	...
	**Endpoint:** `/api/method/approval_engine.settlement.api.v1.kyc_validation.revalidate_in_run`
	**HTTP Method:** POST
	**Parameters:**
...
def test_kyc_vendor(vendor_name: str):
	"""
	        ...
	        **Endpoint:** `/api/method/approval_engine.settlement.api.v1.kyc_validation.test_kyc_vendor`
	        **HTTP Method:** POST
	        **Parameters:**
...
def get_last_kyc_run(supplier: str):
	"""
	        ...
	        **Endpoint:** `/api/method/approval_engine.settlement.api.v1.kyc_validation.get_last_kyc_run`
	        **HTTP Method:** GET, POST
	        **Parameters:**
