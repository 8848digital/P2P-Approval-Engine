...
approval_engine.approval_vendor_portal.utils import ...` across the app keeps
working unchanged.
"""
...
from approval_engine.approval_vendor_portal.portal_display import (
	STATUS_PILL_COLORS,
	base_portal_context,
	get_docstatus_filter,
	status_pill_color,
)
from approval_engine.approval_vendor_portal.portal_nav import (
...
from approval_engine.approval_vendor_portal.vendor_identity import (
