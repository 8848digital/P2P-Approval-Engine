...
context. Split out of approval_vendor_portal/utils.py to keep that file under the
...
from approval_engine.approval_vendor_portal.vendor_identity import get_primary_vendor_supplier_name
