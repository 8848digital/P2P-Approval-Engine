...
Wired into migrate via hooks.py:
    ...
    after_migrate = ["approval_engine.approval_settlement.kyc_validation.setup.run"]

It can still be run manually too:

    bench --site your-site execute approval_engine.approval_settlement.kyc_validation.setup.run
...
from approval_engine.approval_settlement.kyc_validation.setup_data import (
	CHECK_TYPES,
	CREDENTIALS,
	VENDOR_DATA,
	build_vendors,
