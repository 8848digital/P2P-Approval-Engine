...
function create_purchase_order(frm, vendor) {
	frappe.model.open_mapped_doc({
		method: "approval_engine.approval_settlement.api.v1.brn.create_purchase_order_from_brn",
		frm: frm,
		args: { vendor: vendor },
...
function create_purchase_invoice(frm, vendor) {
	frappe.model.open_mapped_doc({
		method: "approval_engine.approval_settlement.api.v1.brn.create_purchase_invoice_from_brn",
		frm: frm,
		args: { vendor: vendor },
		run_link_triggers: true,
	});
...
function recompute_expiry_date(frm) {
	...
	frappe.call({
		method: "approval_engine.approval_settlement.api.v1.brn.get_expiry_date",
		args: {
