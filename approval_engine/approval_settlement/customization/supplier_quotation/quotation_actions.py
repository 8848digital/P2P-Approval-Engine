...
through approval_settlement/api/v1/supplier_quotation.py. Extraction/parsing helpers
...
from approval_engine.approval_settlement.customization.supplier_quotation.supplier_quotation_creation import (
	create_quotation_for_vendor,
)
from approval_engine.approval_settlement.customization.supplier_quotation.supplier_quotation_extraction import (
	extract_tables,
	parse_brn_data,
)
