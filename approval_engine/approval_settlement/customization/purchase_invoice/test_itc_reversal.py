...
class TestGuardClauses(IntegrationTestCase):
	...
	def test_set_itc_status_noop_when_feature_disabled(self):
		...
		with patch(
			"approval_engine.approval_settlement.customization.purchase_invoice.itc_reversal.get_settings",
	...
	def test_daily_sweep_handles_zero_candidate_logs(self):
		...
		module = "approval_engine.approval_settlement.customization.purchase_invoice.itc_reversal"
		with (
