...
approval_settlement/customization/procure_to_pay/dashboard_data.py.
"""
...
def get_dashboard_data(
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.procure_to_pay.get_dashboard_data`
...
def check_access():
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.procure_to_pay.check_access`
	**HTTP Method:** GET, POST
	**Parameters:**
	        None
...
def debug_raw_counts(
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.procure_to_pay.debug_raw_counts`
	**HTTP Method:** GET, POST
	**Parameters:**
...
def debug_line_items(
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.procure_to_pay.debug_line_items`
	**HTTP Method:** GET, POST
	**Parameters:**
	        - doctype (str, required): One of BRN, Purchase Order, Purchase Invoice, Payment Order
	        - company (str, optional): Company to scope the data to
...
def get_error_logs(
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.procure_to_pay.get_error_logs`
	**HTTP Method:** GET, POST
	**Parameters:**
