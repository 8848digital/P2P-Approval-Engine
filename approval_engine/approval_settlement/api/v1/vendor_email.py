...
approval_settlement/doctype/vendor_email/utils.py and approval_settlement/doctype/brn/utils.py.
"""

import frappe

from approval_engine.approval_settlement.doctype.brn.utils import decode_email as _decode_email
from approval_engine.approval_settlement.doctype.vendor_email.utils import create_vendor
...
def send_vendor_mail(
	...
	"""
	        ...
	        **Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.vendor_email.send_vendor_mail`
	        **HTTP Method:** POST
	        **Parameters:**
...
def decode_email(encoded_email: str) -> str:
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.vendor_email.decode_email`
