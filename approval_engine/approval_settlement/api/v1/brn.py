...
approval_settlement/doctype/brn/utils.py and brn_portal.py.
"""
...
from approval_engine.approval_settlement.doctype.brn.utils import (
	_create_pi_from_brn,
...
def create_purchase_order_from_brn(source_name: str):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.brn.create_purchase_order_from_brn`
	**HTTP Method:** POST
	**Parameters:**
...
def create_purchase_invoice_from_brn(source_name: str):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.brn.create_purchase_invoice_from_brn`
	**HTTP Method:** POST
	**Parameters:**
	        - source_name (str, required): The BRN document name to map from
...
def get_expiry_date(date: str, months: int):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.brn.get_expiry_date`
...
def make_purchase_invoice_from_brn(
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.brn.make_purchase_invoice_from_brn`
	**HTTP Method:** POST
	**Parameters:**
