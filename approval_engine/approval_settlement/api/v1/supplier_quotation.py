...
approval_settlement/customization/supplier_quotation/quotation_actions.py.
"""

import frappe

from approval_engine.approval_settlement.customization.supplier_quotation.quotation_actions import (
...
def create_brn(supplier_quotation: str):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.supplier_quotation.create_brn`
	**HTTP Method:** POST
	**Parameters:**
...
def create_supplier_quotation_from_file(file_id: str):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.supplier_quotation.create_supplier_quotation_from_file`
	**HTTP Method:** POST
	**Parameters:**
