...
approval_settlement/customization/purchase_order/utils.py,
approval_settlement/customization/purchase_order/rate_comparison.py, and
approval_settlement/customization/procure_to_pay/utils.py.
"""
...
from approval_engine.approval_settlement.customization.purchase_order.rate_comparison import (
...
def send_po_to_vendor(purchase_order: str):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.purchase_order.send_po_to_vendor`
	**HTTP Method:** POST
	**Parameters:**
...
def make_purchase_invoice_from_portal(
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.purchase_order.make_purchase_invoice_from_portal`
	**HTTP Method:** POST
	**Parameters:**
...
def validate_transaction_date_with_brn_dates(brn: str, transaction_date: str):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.purchase_order.validate_transaction_date_with_brn_dates`
...
def get_fiscal_year_and_validity(date: str, brn: str | None = None):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.purchase_order.get_fiscal_year_and_validity`
	**HTTP Method:** GET, POST
	**Parameters:**
...
def get_vendor_rate_comparison(
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.purchase_order.get_vendor_rate_comparison`
	**HTTP Method:** GET, POST
	**Parameters:**
...
def get_vendor_rate_comparison_config():
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.purchase_order.get_vendor_rate_comparison_config`
	**HTTP Method:** GET, POST
	**Parameters:** None
