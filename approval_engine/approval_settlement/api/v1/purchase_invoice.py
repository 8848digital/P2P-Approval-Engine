...
approval_settlement/customization/purchase_invoice/utils.py and
approval_settlement/customization/purchase_invoice/query.py.
"""

import frappe

from approval_engine.approval_settlement.customization.purchase_invoice.query import (
	get_nature_of_service_options_for_supplier,
)
from approval_engine.approval_settlement.customization.purchase_invoice.utils import (
...
def send_po_to_vendor(purchase_invoice: str):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.purchase_invoice.send_po_to_vendor`
	**HTTP Method:** POST
	**Parameters:**
...
def upload_file_to_pi_from_portal(**args):
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.purchase_invoice.upload_file_to_pi_from_portal`
	**HTTP Method:** POST
	**Parameters:**
...
def get_nature_of_service_query(
	...
	**Endpoint:** `/api/method/approval_engine.approval_settlement.api.v1.purchase_invoice.get_nature_of_service_query`
