# apps/p2p_customization/p2p_customization/patches/v1_0/add_vendor_faq_change_log.py
import frappe
    ...
    if not frappe.db.exists("DocType", "Vendor FAQ Change Log"):
        frappe.get_doc({
            ...
            "fields": [
                ...
                {"fieldname": "old_value", "label": "Old Value", "fieldtype": "Data",
                 "in_list_view": 1, "read_only": 1, "columns": 2},
                {"fieldname": "new_value", "label": "New Value", "fieldtype": "Data",
                 "in_list_view": 1, "read_only": 1, "columns": 2},
                {"fieldname": "changed_on", "label": "Changed On", "fieldtype": "Datetime",
                 "in_list_view": 1, "read_only": 1, "columns": 3},
                {"fieldname": "changed_by", "label": "Changed By", "fieldtype": "Data",
                 "in_list_view": 1, "read_only": 1, "columns": 2},
            ],
            "permissions": [
