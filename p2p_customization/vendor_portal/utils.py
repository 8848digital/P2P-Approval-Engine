...
p2p_customization.vendor_portal.utils import ...` across the app keeps
working unchanged.
"""
...
from p2p_customization.vendor_portal.portal_display import (
	STATUS_PILL_COLORS,
	base_portal_context,
	get_docstatus_filter,
	status_pill_color,
)
from p2p_customization.vendor_portal.portal_nav import (
...
from p2p_customization.vendor_portal.vendor_identity import (
