...
from p2p_customization.settlement.doctype.vendor_email.utils import create_vendor
...
def send_vendor_mail(
	...
	"""
		...
		**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.vendor_email.send_vendor_mail`
		**HTTP Method:** POST
		**Parameters:**
