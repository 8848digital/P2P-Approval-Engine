...
from p2p_customization.settlement.customization.supplier.query import get_nature_of_service_options
from p2p_customization.settlement.customization.supplier.utils import (
...
def send_supplier_message(supplier: str, reason: str, action: str):
	...
	**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.supplier.send_supplier_message`
	**HTTP Method:** POST
	**Parameters:**
...
def send_approval_mail(supplier_name: str, email_id: str):
	...
	**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.supplier.send_approval_mail`
	**HTTP Method:** POST
	**Parameters:**
...
def get_nature_of_service_query(
	...
	**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.supplier.get_nature_of_service_query`
