...
from p2p_customization.settlement.customization.purchase_invoice.query import (
	get_nature_of_service_options_for_supplier,
)
from p2p_customization.settlement.customization.purchase_invoice.utils import (
...
def send_po_to_vendor(purchase_invoice: str):
	...
	**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.purchase_invoice.send_po_to_vendor`
	**HTTP Method:** POST
	**Parameters:**
...
def upload_file_to_pi_from_portal(**args):
	...
	**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.purchase_invoice.upload_file_to_pi_from_portal`
	**HTTP Method:** POST
	**Parameters:**
...
def get_nature_of_service_query(
	...
	**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.purchase_invoice.get_nature_of_service_query`
