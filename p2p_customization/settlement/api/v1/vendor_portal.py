...
from p2p_customization.settlement.vendor_portal_auth import (
...
def vendor_login(usr: str, pwd: str):
	"""
		...
		**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.vendor_portal.vendor_login`
		**HTTP Method:** POST
		**Parameters:**
...
def vendor_web_logout():
	...
	**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.vendor_portal.vendor_web_logout`
...
def vendor_update_password(old_password: str, new_password: str):
	...
	**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.vendor_portal.vendor_update_password`
	**HTTP Method:** POST
	**Parameters:**
...
def vendor_attach_invoice_copy(route: str, docname: str):
	"""
		...
		**Endpoint:** `/api/method/p2p_customization.settlement.api.v1.vendor_portal.vendor_attach_invoice_copy`
		**HTTP Method:** POST
		**Parameters:**
