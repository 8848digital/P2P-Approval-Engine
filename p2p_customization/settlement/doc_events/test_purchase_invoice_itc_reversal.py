...
from p2p_customization.settlement.doc_events.purchase_invoice_itc_reversal import (
...
class TestGuardClauses(IntegrationTestCase):
	...
	def test_set_itc_status_noop_when_feature_disabled(self):
		...
		with patch(
			"p2p_customization.settlement.doc_events.purchase_invoice_itc_reversal.get_settings",
	...
	def test_daily_sweep_handles_zero_candidate_logs(self):
		...
		module = "p2p_customization.settlement.doc_events.purchase_invoice_itc_reversal"
		with (
