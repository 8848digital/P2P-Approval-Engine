...
from p2p_customization.settlement.doctype.portal_invoice_log.utils import (
	get_po_text,
...
class UnitTestPortalInvoiceLogUtils(UnitTestCase):
	...
	def test_send_portal_invoice_notification_skips_when_email_not_configured(self) -> None:
		...
		with (
			patch(
				"p2p_customization.settlement.doctype.portal_invoice_log.utils.is_email_configured",
				return_value=None,
			),
